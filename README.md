...
Install-PSResource -Name PSFileObjectId -Repository LocalGH
```
...
Copy the `PSFileObjectId/` folder into one of your PowerShell module directories:

- **PowerShell 7+:** `$HOME\Documents\PowerShell\Modules\PSFileObjectId\`
- **Windows PowerShell 5.1:** `$HOME\Documents\WindowsPowerShell\Modules\PSFileObjectId\`
